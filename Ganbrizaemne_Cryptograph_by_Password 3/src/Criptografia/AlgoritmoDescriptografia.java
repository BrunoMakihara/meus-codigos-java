 ...
 */
public class AlgoritmoDescriptografia extends javax.swing.JFrame {

    private static final Conversor mensagem = new Conversor();
    
    public AlgoritmoDescriptografia() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Algoritmo de Descriptografia");

        jLabel1.setFont(new java.awt.Font("Dungeon", 1, 18)); // NOI18N
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setText("Algoritmo de Descriptografia com Senha");
        jLabel1.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));

        jLabel2.setFont(new java.awt.Font("Dungeon", 2, 12)); // NOI18N
        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel2.setText("DIGITE O CÓDIGO NO CAMPO ABAIXO, PARA QUE POSSA SER DESCRIPTOGRAFADO");
        ...
        jLabel3.setText("Digite a SENHA de Segurança:");
        ...
        jLabel4.setText("A SUA MENSAGEM SERÁ DESCRIPTOGRAFADA E EXIBIDA NO CAMPO ABAIXO");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // BOTÃO CRIPTOGRAFAR
        try {
            String chave = jPasswordField1.getText();
            ...
            jTextPane2.setText(codigo);
        } catch (Exception e) {
            jTextPane2.setText("ATENÇÃO!!!, DIGITE A SENHA PARA PODER DESCRIPTOGRAFAR A MENSAGEM!");
        }   
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AlgoritmoDescriptografia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AlgoritmoDescriptografia().setVisible(true);
            }
        });
    }
